...
import {Text, View, SafeAreaView, Image, StyleSheet,TouchableOpacity,TextInput} from 'react-native';
      ...
      <View style={styles.container}>
        ...
        <View style={styles.form}>
          <View style={styles.email}>
            <Text>Email</Text>
            <TextInput style={styles.emailField} defaultValue="Enter Your Email" />
          </View>
        </View>
      </View>
    </SafeAreaView>
